...
android {
  ...
  buildTypes {
    getByName("debug") {
      ...
      if (signConfigExists || signConfigExists2) {
        signingConfig = signingConfigs.findByName("swSign")
      }
    }
    ...
    getByName("release") {
      ...
      signingConfig = signingConfigs.findByName(if (signConfigExists || signConfigExists2) "swSign" else "ci")
  ...
  lint {
    ...
    // SW: disable lint on release for now
